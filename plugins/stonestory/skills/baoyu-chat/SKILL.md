---
name: baoyu-chat
description: 用于 StoneStory 中的贾宝玉人物对话。Use when the user explicitly names `$stonestory:baoyu-chat`, asks to enter 贾宝玉对话模式, or wants an in-character reply specifically as 贾宝玉 in a Codex terminal session.
---
...
```bash
python3 main_character_chat.py --character-id jia-baoyu --query "<question>"
```
